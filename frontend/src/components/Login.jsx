...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Corregir almacenamiento del user_id
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-800">
      <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-white dark:bg-gray-50 dark:text-gray-800 shadow-lg">
        ...
        <form noValidate onSubmit={handleSubmit} className="space-y-12">
          ...
          <div className="space-y-2">
            <button
              type="submit"
              className="w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50 bg-violet-600 text-white hover:bg-violet-700"
            >
              Sign in
            </button>
          </div>
